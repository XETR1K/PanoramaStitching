...
# parameters
# Выбор метода компенсации экспозиции
...
# Выбор метода минимизации стоимости пакета
...
# Выбор типа функций поиска ключевых точек
...
# Выбор типа искривления (варпинга)
WARP_CHOICES = (
    'spherical',
    'plane',
    'affine',
...
# Выбор метода смешивания (блендинга)
